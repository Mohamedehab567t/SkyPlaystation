...
# Sky  (used) : mongodb+srv://admin:99059459@pss.eukti.mongodb.net/PS?retryWrites=true&w=majority
client = MongoClient("mongodb+srv://admin:99059459@pss.eukti.mongodb.net/PS?retryWrites=true&w=majority" , tlsCAFile=ca)
